...
export default function BpmnTreeWalker(handler, translate) {
  ...
  function handleDefinitions(definitions, diagram) {
    ...
    } else if (is(rootElement, 'bpmn:Choreography')) {
  ...
  function handleChoreographyActivity(activity, context) {
    ...
    console.log('handleChoreographyActivity', activity, activity.di);
  }
  ...
  function handleChoreography(choreo, context) {
    handleFlowElementsContainer(choreo, context);
    //forEach(choreo.participants, contextual(handleParticipant, context));
